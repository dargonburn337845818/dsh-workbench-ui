...
`;
		...
		function WorkbenchPanel(props) {
			...
			const projectList = projects.map((p) => {
				...
				}, [(0, react.createElement)("span", { className: "wb-dot " + dotClass }), (0, react.createElement)("div", {}, [(0, react.createElement)("div", { className: "wb-proj-name" }, [p.title || p.id]), (0, react.createElement)("div", { className: "wb-proj-meta" }, [`${p.stage} · ${p.gates_pass}/${p.gates_total} 门禁`])])]);
			});
